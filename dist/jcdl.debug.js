...
(function ($) {
  ...
  $.jcdl = {
    ...
    getDownloadLink: function getDownloadLink(data) {
      if (data == null) {
    ...
    _transformToCsv: function _transformToCsv(data) {
    ...
    _encodeString: function _encodeString(str) {
    ...
    _createDataUriHref: function _createDataUriHref(str) {
      return ['data:', 'text/csv;', 'charset=utf-8,', str].join('');
    }
